...
SECURITY = {
    ...
    "hfToken.existingSecret": "the one Secret a warm-up may read (job-shape policy) — cluster",
    "security.jobImageRepos": "the repositories a campaign or warm-up Job may run — cluster",
