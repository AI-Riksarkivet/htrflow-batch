...
# 3636 -> 3695 (audit 0923): an upload the store could not take defers the
...
# and httpx's per-request lines stay out of the run log (W-3).
check wrapper   "$(count packages/wrapper/src -name '*.py')" 3695
