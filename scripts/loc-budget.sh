...
# 3636 -> 3754 (audit 0923): an upload the store could not take defers the
...
# covers the processor's revision too (S-3).
check wrapper   "$(count packages/wrapper/src -name '*.py')" 3754
