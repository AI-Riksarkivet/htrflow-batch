...
A series for people who know htrflow and want to see what runs it at
archive scale: four parts here, and a fifth, on models and signatures, to
come. Each part opens in the browser as a presentation (arrow keys move,
`F` goes full screen) or downloads as a PDF.
