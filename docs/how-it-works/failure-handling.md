...
| `ttlSecondsAfterFinished` | `86400` (24 h) | The campaign Job stays inspectable for a day after its last index finishes, then cleans itself up. By then the wrapper has put everything durable in S3 |
