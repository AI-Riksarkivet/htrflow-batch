...
|---|---|---|---|
| [Batch using Kueue+Helm chart](batch-kueue-helm/feature.md) | #2800 | Transcribe whole archive volumes unattended on the GPU cluster, with results appearing in S3 as they are produced and a web page that shows progress | 87 (16 built, 12 partly, 2 superseded, 57 not started) |
