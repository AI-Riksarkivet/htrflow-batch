...
|---|---|---|---|
| [Batch using Kueue+Helm chart](batch-kueue-helm/feature.md) | #2800 | Transcribe whole archive volumes unattended on the GPU cluster, with results appearing in S3 as they are produced and a web page that shows progress | 90 (25 built, 12 partly, 2 superseded, 51 not started) |
| [Campaigns status page](campaign-status-page/feature.md) | #2923 | The read-only status page for the data scientists running campaigns — every campaign and volume, live logs, links into the viewer, at archive scale | 18 (5 built, 2 partly, 11 not started) |
