...
|---|---|---|---|
| [Batch using Kueue+Helm chart](batch-kueue-helm/feature.md) | #2800 | Transcribe whole archive volumes unattended on the GPU cluster, with results appearing in S3 as they are produced and a web page that shows progress | 56 (19 built, 37 not started) |
| [Campaigns status page](campaign-status-page/feature.md) | #2923 | The read-only status page — every campaign and volume, live logs, links into the viewer — in Swedish, accessible, at archive scale | 13 (3 built, 10 not started) |
