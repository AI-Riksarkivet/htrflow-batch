...
wrapper ≤ 1 850 · converter ≤ 800 · read API ≤ 400 · frontend ≤ 2 500 · chart
...
jobspec was ~600 lines, so 400 was a wrong estimate. Wrapper revised
2026-09-01 after Task 3: synthetic manifests and MAX_SECONDS moved into the
wrapper.)
